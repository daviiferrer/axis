            ...
            <div className="w-full lg:w-1/2 xl:w-[40%] h-screen flex flex-col justify-center items-center px-6 sm:px-12 md:px-16 bg-white relative overflow-y-auto">
                ...
                <div className="w-full max-w-[360px] flex flex-col items-center sm:items-start py-8">
                    ...
                    <div className="w-full text-center sm:text-left">
                        <h2 className="text-2xl sm:text-3xl font-extrabold mb-2 text-slate-900 tracking-tight">Criar sua conta</h2>
                        <p className="text-sm sm:text-base text-slate-500 mb-8 font-medium">Comece a qualificar leads automaticamente em minutos.</p>
                        ...
                        <form className="space-y-4" onSubmit={handleSubmit}>
                            <div className="space-y-1.5 text-left">
                                ...
                                <Input
                                    ...
                                    className="bg-slate-50 border-slate-200 text-slate-900 placeholder:text-slate-400 focus-visible:ring-blue-500 focus-visible:border-blue-500 h-12 rounded-xl px-4 transition-all"
                                    value={name}
                            ...
                            <Button
                                type="submit"
                                disabled={isLoading}
                                className="w-full bg-blue-600 hover:bg-blue-700 text-white h-12 mt-4 rounded-xl font-semibold shadow-md shadow-blue-600/20 disabled:opacity-70 transition-all"
                            >
                            ...
                            <Button
                                type="button"
                                variant="outline"
                                className="w-full h-12 border-slate-200 text-slate-700 font-semibold rounded-xl hover:bg-slate-50 hover:text-slate-900 transition-all shadow-sm"
                                onClick={async () => {
                        ...
                        <p className="text-xs text-slate-500 mt-6 text-center">
                            ...
                            <Link href="/legal/terms" className="text-blue-600 hover:text-blue-700 transition-colors">Termos de Uso</Link>{" "}e{" "}
                            <Link href="/legal/privacy" className="text-blue-600 hover:text-blue-700 transition-colors">Privacidade</Link>.
                        </p>
